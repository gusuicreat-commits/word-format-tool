...
assert.match(pageSource, /重试 Kimi/);
assert.match(pageSource, /改用本地快速解析/);
assert.match(pageSource, /返回修改要求编辑/);
assert.match(pageSource, /正在调用 Kimi 智能解析，复杂要求可能需要 20-60 秒/);
assert.match(pageSource, /Kimi 仍在解析复杂要求，可继续等待或改用本地快速解析/);
...
assert.match(pageSource, /Kimi 规范化清单/);
